...
{
	[SerializeField] private Vector2 MinMaxPointScale = new Vector2(0.05f, 0.15f);
	[SerializeField] private Vector2 MinMaxWanderSpeed = new Vector2(0.1f, 0.4f);

	[Space]
	[SerializeField] private bool DrawEdges = true;
	[SerializeField] [Range(0f, 800f)] private float EdgeThickness = 1f;

	[Space]
	[SerializeField] private float GradientOffset;
	[SerializeField] private float GradientStretch;

	[Space]

	[SerializeField] private Color EdgeColour = Color.black;
	[SerializeField] private Color PointColour = Color.black;
	[SerializeField] private Color BgColourA = Color.white;
	[SerializeField] private Color BgColourB = Color.white;
