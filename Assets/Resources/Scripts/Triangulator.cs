...
public class Triangulator : MonoBehaviour
{
    ...
    [SerializeField] private bool AlwaysRefresh = true;

    [SerializeField] private bool DebugVerticies = true;
    [SerializeField] private bool DebugEdges = true;
    [SerializeField] private bool DebugCircumCircles = true;
    [SerializeField] private bool DebugCircumCentres = true;
    [SerializeField] private bool DebugSupraTriangle = true;
    [SerializeField] private bool DebugBounds = true;

    [SerializeField] private float DebugScale = 0.2f;
    [SerializeField] private Color PointDebugColour = Color.red;
    [SerializeField] private Color EdgeDebugColour = Color.yellow;
    [SerializeField] private Color CircumDebugColour = Color.green;
	...
	///Editor only
#if UNITY_EDITOR
	[HideInInspector] public bool ShowPointData;
	[HideInInspector] public bool ShowDebugData;
#endif
